...
namespace Myschool
{
    public partial class FrmAXMCX : Form
    {
        public FrmAXMCX()
        {
            InitializeComponent();
        ...
        {
            lvSelect1.Items.Add("输快点呀！！！");
            if(txtName.Text.Length>=2)
            {
            lvSelect1.Items.Clear();
            lvSelect1.Items.Add("输快点呀！！！");
            }
        }
        #endregion
        ...
        public void select()
        {
            ...
            + string.Format(" where StudentName = '{0}'",Name);
            //创建执行对象
