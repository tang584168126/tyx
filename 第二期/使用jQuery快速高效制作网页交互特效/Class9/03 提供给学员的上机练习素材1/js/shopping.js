...
$(function($){
   ...
   //计算总价
    ...
    $("#removeAllProduct").click(function(){
        ...
        $(".shopping_list_border").append("<div class='empty_product'><img src='images/register_pic_01.gif'/><div>您还没有挑选商品，<a href='index.html'>去挑选看看>></a></div></div>");
...
$(function(){
	...
	function totalPrice(){
		...
		$("#myTableProduct").find("tr").each(function(i,e){
			//获取当前商品数量
			var num=$(e).children(".shopping_product_list_5").children("input").val();
			//获取商品价格
			var price=$(e).children("")
		});
	}
	totalPrice();
})
