    ...
    public partial class frmMain : Form
    {
        ...
        public void ChangeHealth()
        {
            ...
            if(!healthName.Equals("请选择"))
            {
                ...
                this.dgvList.DataSource = new BindingList<HealthItem>(this.dicHealthList[healthName].ItemList);
            }
            else
            {
        ...
        public void InsertHealthItem()
        {
            ...
            #region 添加操作
            //添加体检项目
            this.dicHealthList[healthName].ItemList.Add(this.dicHealthItemList[healthItemName]);
