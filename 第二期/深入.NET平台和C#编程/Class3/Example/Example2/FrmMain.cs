...
namespace Example2
{
    public partial class FrmMain : Form
    {
        ...
        #region 字段
        //学员列表
        private Hashtable hashStuList = new Hashtable();
        #endregion
        ...
        public void InsertStu()
        {
            ...
            //验证学号是否存在
            if(this.hashStuList.ContainsKey(strStuNo))
            {
            ...
            //HashTable的元素是
            this.hashStuList.Add(strStuNo, objStu);
        ...
        public void DeleteStu()
        {
            ...
            //删除HashTable元素
            this.hashStuList.Remove(strStuNo);
        ...
        public void BindData()
        {
            ...
            //遍历HashTable元素
            foreach(object objKey in this.hashStuList.Keys)
            {
                //拆箱至Student类
                Student objStu = (Student)hashStuList[objKey];
