...
namespace Example3
{
    public partial class FrmMain : Form
    {
        ...
        #region 字段
        //学员列表
        private List<Student> objStuList = new List<Student>();
        #endregion
        ...
        public void InsertStu()
        {
            ...
            //验证学生是否存在
            for (int i = 0; i < objStuList.Count; i++)
            {
                if (objStuList[i].StuNO.Equals(objStu.StuNO))
                {
        ...
        public void UpdateStu()
        {
            ...
            #region 修改操作
            //循环列表
            for (int i = 0; i < this.objStuList.Count; i++)
            {
                if (this.objStuList[i] != null && this.objStuList[i].StuNO.Equals(objStu.StuNO))
                {
                    this.objStuList[i] = objStu;
        ...
        public void DeleteStu()
        {
            #region 设置变量
            //需要删除的学号
            string stuNO = this.dgvList.SelectedRows[0].Cells[0].Value.ToString().Trim();
            #endregion

            #region 删除操作
            for (int i = 0; i < this.objStuList.Count; i++)
            {
                if (this.objStuList[i].StuNO.Equals(stuNO))
                {
                    this.objStuList.RemoveAt(i);
        ...
        public void BindData()
        {
            ...
            //绑定学员信息
            this.dgvList.DataSource = new BindingList<Student>(objStuList);
        }
