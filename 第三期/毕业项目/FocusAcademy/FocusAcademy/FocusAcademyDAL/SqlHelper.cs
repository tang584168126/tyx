...
{
	//<connectionStrings>
    //<!--<add name="DataBase" connectionString="Data Source=localhost;Initial //Catalog=BookShopPlus;Integrated Security=True;Min Pool Size=0;Max Pool Size=4;Connect //Timeout=10"/>-->
    //<add name="BookShop" connectionString="Data Source=.;Initial //Catalog=BookShop;Integrated Security=True;Min Pool Size=1;Max Pool Size=5;Connect //Timeout=10"/>
  //</connectionStrings>
    ...
    public abstract class SqlHelper
    {
        ...
        public static readonly string ConnectionString = ConfigurationManager.ConnectionStrings["FocusBookEntities"].ConnectionString;
