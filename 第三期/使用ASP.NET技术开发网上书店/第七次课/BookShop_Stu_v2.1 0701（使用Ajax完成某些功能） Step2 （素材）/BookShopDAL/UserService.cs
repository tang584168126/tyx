...
namespace BookShop.DAL
{
    public class UserService
    {
        ...
        public bool AddUser(User user)
        {
            ...
            //int result = SqlHelper.ExecuteNonQuery(SqlHelper.ConnectionString, "usp_InsertRegisterUser", paras);
        ...
        public List<User> GetUsersByRoleId(int roleId)
        {
            ...
            string sqlText = "select * from Users where UserRoleId = @UserRoleId";
            SqlParameter para = new SqlParameter("@UserRoleId", roleId);
