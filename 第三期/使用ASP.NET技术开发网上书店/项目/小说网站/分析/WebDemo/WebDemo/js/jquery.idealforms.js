 ...
 */
$.idealforms.errors = {
  userId:'昵称在2~10之间，且暂不支持特殊字符！',
  required: '此处是必填的.',
  number: '必须是数字.',
  digits: '必须是唯一的数字.',
  name: '必须至少有3个字符长，并且只能包含字母.',
  username: '必须在8之间和3个字符长，不能是中文并以字母开头。(.)',
...
var getFilters = function() {
  ...
  var filters = {
    ...
    required: {
     ...
     userId: {
      regex:/^[\u4E00-\u9FA5\A-Za-z]{2,10}$/, 
      error: $.idealforms.errors.userId
    },
...
var _defaults = {
  ...
  customFlags: {},
  globalFlags: '',
  onSuccess: function(e) { alert('非常感谢你的耐心！--焦点书院') },
