...
<div id="floatTools" class="rides-cs" style="height:246px;">
  ...
  <div id="divFloatToolsView" class="floatR" style="display: none;height:237px;width: 140px;">
    <div class="cn">
      <h3 class="titZx">焦点书院客服</h3>
      <ul>
        <li><span>小苍</span> <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=123456789&site=qq&menu=yes"><img border="0" src="images/online.png" alt="点击这里给我发消息" title="点击这里给我发消息"/></a> </li>
        <li><span>小志</span> <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=123456789&site=qq&menu=yes"><img border="0" src="images/online.png" alt="点击这里给我发消息" title="点击这里给我发消息"/></a> </li>
        <li><span>投诉</span> <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=123456789&site=qq&menu=yes"><img border="0" src="images/online.png" alt="点击这里给我发消息" title="点击这里给我发消息"/></a> </li>
        <li>
            <a href="#" target="_blank">提交BUG</a>
            <a href="#" target="_blank">官方留言</a>
            <div class="div_clear"></div>
        </li>
        <li style="border:none;"><span>电话：438-438-9438</span> </li>
      </ul>
    </div>
  </div>
</div>
