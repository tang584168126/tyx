...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function registUser() {
            ...
            var userInfo = "&loginId=" + escape(loginId) + "&loginPwd=" + escape(loginPwd)
                + "&name=" + escape(name) + "&mail=" + escape(mail) + "&address=" + escape(address)
                + "&phone=" + escape(phone);
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <img src="Images/register.gif" alt="会员注册" /></h2>
        <p>
            ...
            <span id="loginIdMsg" style="color:red;display:none">此帐号已经被注册！</span>
            <asp:RequiredFieldValidator ID="rfvLoginId" runat="server" ControlToValidate="txtLoginId" Text="请输入用户名"></asp:RequiredFieldValidator></p>
        <p>
