<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="BookEdit.aspx.cs" Inherits="BookShopWeb.Admin.BookEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <table cellspacing="1" cellpadding="3" class="table_edit">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtToc" runat="server" Height="200px" TextMode="MultiLine" Width="600px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <th>
        ...
        <tr>
            <td colspan="2">
                &nbsp;&nbsp;
                <asp:Button ID="bntSave" runat="server" Text="保 存" />
            </td>
        </tr>
    </table>
</asp:Content>
