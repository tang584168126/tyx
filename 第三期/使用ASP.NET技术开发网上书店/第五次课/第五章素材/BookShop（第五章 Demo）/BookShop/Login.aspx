...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <p>
        <label>用户名</label>
        <asp:TextBox ID="txtLoginId" CssClass="opt_input" runat="server"></asp:TextBox>
    </p>
    <p>
        <label>密&#160;&#160;码</label>
    ...
    <p class="form_sub">
        <asp:Button ID="btnSubmit" CssClass="opt_sub" runat="server" Text="登入" OnClick="btnSubmit_Click" />
        <a href="#">忘记密码？</a>
    </p>
</asp:Content>
