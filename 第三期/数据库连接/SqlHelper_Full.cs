...
namespace MTRC.ACS.Utility.DataHelper
{
    /// <summary>
    ...
    public sealed class SqlHelper {
        ...
        private static readonly string connectionString = ConfigurationHelper.DBConnection;
        private static readonly int timeout = Convert.ToInt32(ConfigurationHelper.CmdTimeout);
        ...
        public static DataSet ExecuteDatasetWithRet(ref int retVal, string spName, SqlParameter[] parameterValues)
        {
            return ExecuteDatasetWithRet(ref retVal, connectionString, CommandType.StoredProcedure, spName, parameterValues);
        }

        public static DataSet ExecuteDatasetWithRet(ref int retVal, string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            using (SqlConnection cn = new SqlConnection(connectionString))
            {
                cn.Open();
