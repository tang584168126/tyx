...
namespace bdqn.houses.DAL
{
    ...
    public partial class HouseService
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(bdqn.houses.Model.House model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(bdqn.houses.Model.House model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public bdqn.houses.Model.House GetModel(int HouseId)
        {
            ...
            bdqn.houses.Model.House model = new bdqn.houses.Model.House();
