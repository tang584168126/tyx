...
//        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(bdqn.houses.Model.User model)
        {
            StringBuilder strSql = new StringBuilder();
...
//        }
        ...
        /// 得到一个对象实体
        /// </summary>
        public bdqn.houses.Model.User GetModel(string LoginName)
        {
            ...
            bdqn.houses.Model.User model = new bdqn.houses.Model.User();
        ...
        /// 得到一个对象实体
        /// </summary>
        public bdqn.houses.Model.User GetModel(int LoginId)
        {
