...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="action_area" class="member_form">
        ...
        <form action="<% =Url.Content("~/Account/Login")%>" method="post">
            ...
            <p>
                <label>用户名</label><input name="userName" type="text" value="<%=userName %>"  class="opt_input" /><%=Html.ValidationMessage("userName") %>
            </p>
            <p>
            ...
            <p class="form_sub">
                <input type="checkbox" name="RecordMe" checked="checked" />
                在此计算机上保留我的用户名和密码
            </p>
            <p class="form_sub">
