...
<link href="Styles/answer.css" rel="stylesheet" type="text/css" />
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="book_view">
        ...
        <dl class="put_book">
            <dt>
                <img src="Images/books.jpg" alt="暮光之城-月食" />
                <div class="chakan">
                    <img src="Images/zoom.gif" />
                    <a class="gray878787a" href="#" name="bigpicture">点击查看大图</a></div>
            </dt>
            <dd>
                <div id="book_editor">作　　者： <%=Model.Author %>著<br />
                    出 版 社： <%=Model.Publisher.Name %></div>
                ...
                <div id="book_point">
                    ...
                    <br />
                    <a href="#">
                        <img src="Images/btn_goumai.gif" onmouseover="this.src='Images/btn_goumai_click.gif'" onmouseout="this.src='Images/btn_goumai.gif'" /></a>
                    <a href="#">
                        <img src="Images/btn_zancun.gif" onmouseover="this.src='Images/btn_zancun_click.gif'" onmouseout="this.src='Images/btn_zancun.gif'" /></a>
                </div>
                    ...
                    <div class="total_body">
                        <div class="people_average">
                            <div class="average_left">
                                <p>购买过的顾客平均评分</p>
                                <span class="a_red28b pd">4</span><span class="red_bold">星半</span><img src='images/star_red.gif' /><img src='images/star_red.gif' /><img src='images/star_red.gif' /><img src='images/star_red.gif' /><img src='images/star_redgray_big.gif' />
                            </div>
                        ...
                        <div class="write_comm">
                            <a id="reviewTipa" href="#">
                                <img src="images/button_write_comm.gif" border="0" title="写评论" /></a>
                        </div>
