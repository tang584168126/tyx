<%@ Page Title="" Language="C#" MasterPageFile="~/Common.Master" AutoEventWireup="true" CodeBehind="BookDetail.aspx.cs" Inherits="PageStaticTechnology.BookDetail" %>
        ...
        <dl class="put_book">
            ...
            <dd>
                <div id="book_editor">
                    ...
                    著<br />
                    出 版 社：<asp:Label runat="server" ID="lblPublisher"></asp:Label>
                </div>
