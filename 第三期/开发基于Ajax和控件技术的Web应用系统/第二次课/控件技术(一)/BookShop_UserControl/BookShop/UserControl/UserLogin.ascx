<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.ascx.cs" Inherits="BookShop.UserControl.UserLogin" %>
...
<h2 class="action_type"><img src="Images/login_in.gif" alt="会员登录" /></h2>
    ...
    <p>
        ...
        <asp:RequiredFieldValidator ID="rfvLoginId" runat="server" ControlToValidate="txtLoginId" Text="请输入登陆名"></asp:RequiredFieldValidator>
    </p>
    <p>
        <label>密&#160;&#160;码</label>
        <asp:TextBox ID="txtPassword" runat="server" CssClass="opt_input"></asp:TextBox>
        <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ControlToValidate="txtPassword" Text="请输入密码"></asp:RequiredFieldValidator>
    </p>
    <p>
        <label>&nbsp;</label>
    ...
    <p>
        ...
        <asp:RequiredFieldValidator ID="rfvCode" runat="server" ControlToValidate="txtCode" Text="请输入验证码"></asp:RequiredFieldValidator>
    </p>
